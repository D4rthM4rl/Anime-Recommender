...
def scrape_music(anime_name, output_path):
    ...
    for title, url in osts:
        with yt_dlp.YoutubeDL({"quiet": True}) as ydl:
            ...
            if duration > 15 * 60 and "extended" not in title:
    ...
    if long_video:
        ...
        for video in other_videos[:4]:
            ...
            download_clips(url, duration, title, sanitized_title, output_path=output_path, num_clips=1)
